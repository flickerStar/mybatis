...
public class QueryExample {
	...
	protected abstract static class GeneratedCriteria {
		...
		public Criteria orLike(String field,String value) {
            addCriterion((field.startsWith("t.") ? field.replace("t.", "") : "t." + field) + " like ", "%"+value+"%", field, OR);
            return (Criteria) this;
        }
		...
		public Criteria orNotLike(String field, Object value) {
			addCriterion((field.startsWith("t.") ? field.replace("t.", "") : "t." + field) + " not like ", "%"+value+"%", field, OR);
			return (Criteria) this;
		}
